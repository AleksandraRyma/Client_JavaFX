...
public class EmployeeHomeController {
    ...
    public void goToSeeAllSalary(ActionEvent actionEvent) throws IOException {
        paySlipBtn.getScene().getWindow().hide();
        FXMLLoader loader = new FXMLLoader();
    ...
    @FXML
    public void goToSeePaySlip(ActionEvent actionEvent) throws IOException {
        payrollSalaryBtn.getScene().getWindow().hide();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/payslipContrller.fxml"));
        try {
            loader.load();
        } catch (IOException e) {
            throw new RuntimeException(e);
